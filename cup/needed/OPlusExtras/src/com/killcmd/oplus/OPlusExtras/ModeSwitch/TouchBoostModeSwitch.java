...
*
*/
package com.killcmd.oplus.OPlusExtras.modeswitch;
...
public class TouchBoostModeSwitch implements OnPreferenceChangeListener {
    ...
    private static final int NODE = R.string.node_touchboost_mode_switch;
    ...
    public static boolean isCurrentlyEnabled(Context context) {
        return FileUtils.getFileValueAsBoolean(getFile(context), false,
            context.getResources().getString(R.string.node_touchboost_mode_switch_true),
            context.getResources().getString(R.string.node_touchboost_mode_switch_false));
    }
