...
*
*/
package com.killcmd.oplus.OPlusExtras;
...
import com.killcmd.oplus.OPlusExtras.doze.DozeSettingsActivity;
import com.killcmd.oplus.OPlusExtras.FileUtils;
import com.killcmd.oplus.OPlusExtras.modeswitch.*;
import com.killcmd.oplus.OPlusExtras.preferences.*;
import com.killcmd.oplus.OPlusExtras.R;
import com.killcmd.oplus.OPlusExtras.services.*;
import com.killcmd.oplus.OPlusExtras.slider.SliderConstants;
import com.killcmd.oplus.OPlusExtras.touch.TouchscreenGestureSettings;
...
public class OPlusExtras extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        // Wireless Charging
        powerCategory = powerCategory | isFeatureSupported(context, R.bool.config_deviceSupportsWirelessCharging);
        if (isFeatureSupported(context, R.bool.config_deviceSupportsWirelessCharging)) {
            mWirelessChargingModeSwitch = (TwoStatePreference) findPreference(KEY_WIRELESS_CHARGING_SWITCH);
            mWirelessChargingModeSwitch.setEnabled(WirelessChargingModeSwitch.isSupported(this.getContext()));
            mWirelessChargingModeSwitch.setChecked(WirelessChargingModeSwitch.isCurrentlyEnabled(this.getContext()));
            mWirelessChargingModeSwitch.setOnPreferenceChangeListener(new WirelessChargingModeSwitch());
        }
        else {
           findPreference(KEY_WIRELESS_CHARGING_SWITCH).setVisible(false);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mAutoHBMSwitch) {
            ...
            Intent fpsinfo = new Intent(this.getContext(),
                    com.killcmd.oplus.OPlusExtras.services.FPSInfoService.class);
            if (enabled) {
